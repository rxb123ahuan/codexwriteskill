...
- [ ] 信息跟着冲突走（通过事件传递设定）
- [ ] 设定量可控（一章不超 3 个新概念）
- [ ] 没有提前披露：角色只知道自己能观察、调查、推理得到的信息
- [ ] 金手指/隐藏身份/幕后真相没有被无知情权限的角色准确说出
- [ ] 如有 `追踪/信息权限.md`，本章对话和旁白已逐项对照
...
| 章节字数偏离目标 | **high** | 强制扩充（优先补充子事件/情节点，再展开），直到达标 |
...
| 信息权限泄漏：角色说出无从得知的秘密 | critical | 改成可见现象、错误推断、模糊怀疑或先补知情桥段 |
| 时间线错误 | high | 标记时间线并修正 |
