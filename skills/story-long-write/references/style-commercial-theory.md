...
本文件以"创作策略"语气书写。内容是经过市场验证的商业网文核心方法论，所有公式和原则都是**经过验证的创作框架**，不是理论探讨。遇到冲突时：市场数据 > 读者情绪 > 作者偏好。
...
- 当核心看点的数据表现稳定时保持重复策略，数据下降时分析是否需要升级重复方式
...
### 梗收集方式
- 从目标平台的热门评论、弹幕高频词中提取可用的梗元素，建立梗-场景映射表
- 梗是创作灵感源泉，不是简单堆积
- 经典梗读者仍会期待 -> 巧妙运用满足期待
