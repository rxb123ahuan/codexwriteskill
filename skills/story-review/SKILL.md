...
- 提示指令：
  ...
  4. 角色行为是否符合其动机？
  5. 对话是否有潜台词和信息控制？
  6. 是否存在提前披露：角色说出自己无从得知的金手指、隐藏身份、幕后真相、未来计划？
  7. 爱情线好感度与CP行为是否匹配？（参见 character-relations "好感度体系"）
  8. 好感度进度是否可感知？
...
- 提示指令：
  ...
  3. 伏笔是否合理埋设/回收？
  4. 时间线是否自洽？
  5. 信息权限是否自洽？对照 `追踪/信息权限.md`（如存在），检查每个角色是否只说出了自己能知道的信息。
  6. 伏笔密度是否合理？

  严重度：
  - S1：角色准确说出其无从得知的金手指/隐藏身份/核心秘密
  - S2：角色推断过准，缺少证据链
  - S3：旁白或对话暗示过直，削弱信息差
