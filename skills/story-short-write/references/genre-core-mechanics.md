...
| 《十方武圣》 | 杀光所有人换地图 | 核心情绪崩坏，订阅腰斩 | 换地图不要杀光旧角色 |
...
不能模仿升级文突破模式(牵手/接吻/上床是一次性的)。正确循环：稳定人设组合+变化情境=无限可用套路(学习短视频固定流程重复拍模式)。感情升温通过共同困境/互相理解/意外发现，非身体接触升级。
...
结构共性：中间写法一致(逐个暧昧不确认关系，结局确认)。后宫规则：不能和一个确认后再攻略下一个(显渣男)。修罗场三处理：一笔带过/关联回事业线(最推荐)/被害人设梗。炒股结尾建议开放性结局。
