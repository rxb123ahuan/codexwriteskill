...
本文件以"操作指令"语气书写。所有规则都是**必须遵守**的写作约束，不是建议。遇到冲突时：镜头式写作法的规则 > 基础技巧的建议 > 认知类的参考。
...
- [ ] **段落控制**：每段不超过3句，手机屏幕可一屏看完
- [ ] **禁用词扫描**：无"仿佛/犹如/一丝/不禁/眼中闪过/嘴角勾起"
- [ ] **禁用句式扫描**：无"XX说道"/"他感到"/"带着一丝XX"
