...
7. 信息权限清单：哪些秘密读者知道、主角知道、配角不知道；短篇反转/隐藏身份/金手指尤其要列清楚
...
**写完后对照 小节大纲.md 检查**：每个子事件三层都展开了？本节情绪到位？伏笔/物件已植入？是否有角色提前说出自己不该知道的秘密？节长 <800 字 → 回查感知层/反应层补足后再写下一节。
...
- 去AI味（6 Gate）和格式合规检查
- 事实冲突、伏笔断线、角色属性不一致检查
- 信息权限检查：隐藏身份、金手指、反转真相是否被无知情角色提前准确说出
